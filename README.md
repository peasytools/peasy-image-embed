...
[![npm](https://img.shields.io/npm/v/peasy-image-embed)](https://www.npmjs.com/package/peasy-image-embed)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Zero Dependencies](https://img.shields.io/badge/dependencies-0-brightgreen)](https://www.npmjs.com/package/peasy-image-embed)
[![Size](https://img.shields.io/badge/gzipped-<8KB-green)](https://bundlephobia.com/package/peasy-image-embed)

Embed **PeasyImage** widgets on any website or blog. Image conversion, compression, resizing, and format tools. Each widget is completely isolated via **Shadow DOM**, requires **zero dependencies**, and supports **3 built-in themes** (light, dark, sepia). The self-executing script finds all `data-peasy-image` elements on the page and renders interactive widgets automatically, including support for dynamically added elements in single-page applications via MutationObserver.

PeasyImage is part of the [Peasy Tools](https://peasytools.com) ecosystem, providing 11 widget types for embedding file format information, tool cards, conversion guides, glossary terms, search boxes, and interactive tools directly into your pages.

> **Try the interactive widget builder at [widget.peasyimage.com](https://widget.peasyimage.com)** -- build, preview, and copy embed code for any widget type.

<p align="center">
  <img src="demo.gif" alt="peasy-image-embed demo -- embed peasyimage widgets with Shadow DOM isolation and theme support" width="800">
</p>
...
That's it. The script will find all `data-peasy-image` elements, fetch data from the PeasyImage API, and render each widget with full Shadow DOM style isolation.

## Widget Types

PeasyImage supports 11 widget types -- 11 common types available on all Peasy sites.

| Type | Description | Usage |
|------|-------------|-------|
| `format` | File format info card with specs, MIME type, and use cases | `<div data-peasy-image="format" data-slug="..."></div>` |
| `tool` | Tool card with description and direct launch link | `<div data-peasy-image="tool" data-slug="..."></div>` |
| `convert` | Conversion card showing input/output format pair | `<div data-peasy-image="convert" data-slug="..."></div>` |
| `compare` | Side-by-side comparison of two formats or tools | `<div data-peasy-image="compare" data-slug="..."></div>` |
| `glossary` | Glossary term tooltip with definition on hover | `<div data-peasy-image="glossary" data-slug="..."></div>` |
| `gallery` | Grid gallery of available tools for a category | `<div data-peasy-image="gallery" data-slug="..."></div>` |
| `guide` | Guide/tutorial card with summary and read-more link | `<div data-peasy-image="guide" data-slug="..."></div>` |
| `usecase` | Use-case card showing when and why to use a tool | `<div data-peasy-image="usecase" data-slug="..."></div>` |
| `badge` | Inline badge showing format type or tool category | `<div data-peasy-image="badge" data-slug="..."></div>` |
| `search` | Search box with autocomplete for tools and formats | `<div data-peasy-image="search" data-slug="..."></div>` |
| `interactive` | Embedded interactive tool via iframe | `<div data-peasy-image="interactive" data-slug="..."></div>` |
...
|-----------|--------|---------|-------------|
| `data-peasy-image` | format, tool, convert, compare, glossary, gallery, guide, usecase, badge, search, interactive | *required* | Widget type to render |
...
<div data-peasy-image="format" data-slug="webp" data-theme="light"></div>

<!-- Dark theme -- dark background, light text -->
<div data-peasy-image="format" data-slug="webp" data-theme="dark"></div>

<!-- Sepia theme -- warm, paper-like appearance -->
<div data-peasy-image="format" data-slug="webp" data-theme="sepia"></div>

<!-- Auto theme -- follows prefers-color-scheme -->
<div data-peasy-image="format" data-slug="webp" data-theme="auto"></div>
```

Each theme sets CSS custom properties inside the Shadow DOM. The accent color (`#8B5CF6`) is consistent across all themes, providing brand recognition for PeasyImage.
...
```html
<script type="module">
  import 'https://cdn.jsdelivr.net/npm/peasy-image-embed@1/dist/embed.esm.js';
</script>
```
...
```html
<!-- PeasyImage format info card with light theme -->
<div data-peasy-image="format" data-slug="webp" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-image-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- PeasyImage tool card -->
<div data-peasy-image="tool" data-slug="webp" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-image-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Search across PeasyImage tools and formats -->
<div data-peasy-image="search"
  data-placeholder="Search PeasyImage tools..."
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-image-embed@1/dist/embed.min.js"></script>
```
...
```html
<p>This file is in <div data-peasy-image="badge" data-slug="webp"></div> format.</p>
<script src="https://cdn.jsdelivr.net/npm/peasy-image-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Embed an interactive PeasyImage tool -->
<div data-peasy-image="interactive"
  data-slug="image/example-tool"
  data-height="500"
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-image-embed@1/dist/embed.min.js"></script>
...
> **Note:** The `data-slug` value uses the format `category-slug/tool-slug`. Find available tools at [peasyimage.com/api/v1/tools/](https://peasyimage.com/api/v1/tools/).
...
```html
<div data-peasy-image="glossary" data-slug="lossless" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-image-embed@1/dist/embed.min.js"></script>
```
...
- **CORS**: PeasyImage API has CORS enabled for all origins
...
- **Powered by**: Each widget includes a subtle "PeasyImage" backlink in the footer

## Learn More

Visit [peasyimage.com](https://peasyimage.com) for the full PeasyImage experience.

- **All Tools**: [peasyimage.com](https://peasyimage.com)
- **Formats**: [peasyimage.com/formats/](https://peasyimage.com/formats/)
- **Glossary**: [peasyimage.com/glossary/](https://peasyimage.com/glossary/)
- **Guides**: [peasyimage.com/guides/](https://peasyimage.com/guides/)
- **API Documentation**: [peasyimage.com/developers/](https://peasyimage.com/developers/)
- **OpenAPI Spec**: [peasyimage.com/api/openapi.json](https://peasyimage.com/api/openapi.json)
- **Widget Builder**: [widget.peasyimage.com](https://widget.peasyimage.com)
- **npm Package**: [npmjs.com/package/peasy-image-embed](https://www.npmjs.com/package/peasy-image-embed)
