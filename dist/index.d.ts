/**
 * peasy-image-embed -- TypeScript declarations
 *
 ...
 *
 * Usage:
 *   <div data-peasy-image="format" data-slug="pdf" data-theme="light"></div>
 *   <script src="https://cdn.jsdelivr.net/npm/peasy-image-embed@1/dist/embed.min.js"></script>
 */

declare module 'peasy-image-embed' {
  // Self-executing -- no exports needed
  // Use data-peasy-image attributes to create widgets
}
